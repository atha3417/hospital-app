...
if (isset($_POST['add'])) {
	...
	if ($sql) {
		echo "<script>alert('Succesfully Add ".$total." Data!'); window.location='data.php'</script>";
	} else {
		echo "<script>alert('Failed to Add Data!'); window.location='generate.php'</script>";
	}
	...
	echo "<script>alert('Succesfully Update Data!'); window.location='data.php'</script>";
}
?>