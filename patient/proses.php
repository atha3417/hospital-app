...
if (isset($_POST['add'])) {
	...
	unlink($target_file);
	if ($sql) {
		echo "<script>alert('Succesfully Import Data!'); window.location='data.php'</script>";
	} else {
		echo "<script>alert('Failed to Import Data!'); window.location='import.php'</script>";
	}
}
?>